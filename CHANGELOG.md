...
### Added
- AI 解卦摘要卡：有动爻时**本卦→变卦两张卦象图并排**（中间变箭头），本卦/变卦均可点击跳转卦库详情

### Fixed
- 修复 v2.8.0 摘要卡只在手机上显示旧版的问题（改动此前未真正装机，现随本版同步真机+模拟器）

## [2.8.0] - 2026-09-21

### Added
- AI 解卦页的卦象/卦名、变卦可点击，跳转卦库对应卦详情

### Changed
- 空白发送的默认解卦严格只看卦象，不再结合历史对话上下文
...
### Added
- 原生 macOS App（复用同一套 SwiftUI 源码与 YijingCore），本地 ad-hoc 签名即可运行
- 构建运行脚本 `scripts/mac.sh`

## [2.4.4] - 2026-09-20

### Changed
- App 图标放大（中心裁切 1664 再缩放，符号更饱满、四周保留安全边距）

## [2.4.3] - 2026-09-20

### Changed
- App 图标改用无水印版；移除误入仓库的图标源图
...
[2.8.0]: https://github.com/ALeiQ/yijing64/releases/tag/v2.8.0
